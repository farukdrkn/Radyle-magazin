  ...
  return (
    ...
    >
      <div className="flex flex-col">
        ...
        <div className="p-6 bg-white rounded-b-[2rem] shadow-xl border-t border-gray-50 space-y-3 group-hover:bg-gray-50 transition-colors">
          {post.category && (
            <span className="text-blue-600 text-[10px] font-bold uppercase tracking-[0.2em] block">
              {post.category}
            </span>
          )}
          <h2 className="text-lg font-black text-gray-900 leading-tight uppercase group-hover:text-indigo-600 transition-colors line-clamp-2">
            {post.title}
          </h2>
          <p className="text-[11px] leading-relaxed text-gray-500 font-medium line-clamp-3">
            {excerpt}
          </p>
        </div>
      </div>
